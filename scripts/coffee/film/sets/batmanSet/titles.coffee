module.exports = [
	...
	"
	<h6 class=\"the-dark-knight\">The Dark Knight</h6>
	"
	...
	"
	<h6>Based upon characters from</h6>
	<ul>
		<li>DC Comics</li>
	</ul>
	"
	...
	"
	<h6>Executive Producers</h6>
	<ul>
		<li>Benjamin Melinker</li>
		<li>Michael E. Uslan</li>
	</ul>
	"
	...
	<h6>a</h6>
	<ul>
		<li>Warner Brothers Pictures</li>
		<li class=\"little\">production</li>
	</ul>
	"

	"
	<h6>&ldquo;Like a Dog Chasing Cars&rdquo; by</h6>
	<ul>
		<li class=\"little\">
			HANS ZIMMER <br>
			and JAMES NEWTON HOWARD<br>
			from The Dark Knight Original Soundtrack
		</li>
	</ul>
	"
